...
import openpyxl
import re
from mongo import timeit, search_file_in_dir

incoming_dir = 'Additives'
"""Дирректроия с файлом Добавки (Е-индексы + Ключевые слова к ним)"""

excel = search_file_in_dir(incoming_dir=incoming_dir)
...
@timeit
def search_andcorrect_spaces(document):
